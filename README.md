...
| ----------------------------- | ----------------------------------------------------------   |
| Hardware C API                | https://docs.quanser.com/quanser-sdk/documentation/quarc_c_hardware_c.html |
| Communications C API          | https://docs.quanser.com/quanser-sdk/documentation/quarc_c_comm_c.html |
| Devices C API                 | https://docs.quanser.com/quanser-sdk/documentation/quarc_c_devices_c.html |
| Multimedia C API              | https://docs.quanser.com/quanser-sdk/documentation/quarc_c_multimedia_c.html |
| Error Handling/Messages C API | https://docs.quanser.com/quanser-sdk/documentation/quarc_c_error_handling_c.html |
| Python API's                  | https://docs.quanser.com/quanser-sdk/documentation/python/index.html |
